...
PetscReal find_value( const parameters                              params,
                      ...
                      const int j, const PetscReal dr = .01 )
{
                 ...
                 const boost::function<PetscReal( PetscReal )> potential )
{
    ...
    boost::function<PetscReal( int, int )> fv = boost::bind<PetscReal>(
        find_value<order, element>, boost::ref( params ),
        boost::cref( potential ), boost::cref( knots ), _1, _2, 0.01 );
    Mat H =
