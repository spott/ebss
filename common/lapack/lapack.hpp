...
// LIWORK, INFO )
extern "C" {
void dsbevd_( const char* jobz, const char* uplo, int* n, int* kd, double* ab,
              int* ldab, double* w, double* z, int* ldz, double* work,
              int* lwork, int* iwork, int* liwork, int* info );
void dsbev_( const char* jobz, const char* uplo, int* n, int* kd, double* ab,
             int* ldab, double* w, double* z, int* ldz, double* work,
             int* info );
}
...
int dsbevd( int n, int kd, double* input, double* evalues )
{
    ...
    dsbevd_( "N", "U", &n, &kd, input, &ldab, evalues, null, &n, work, &lwork,
             iwork, &liwork, &info );
...
int dsbevd( int n, int kd, double* input, double* evalues, double* evectors )
{
    ...
    dsbevd_( "V", "U", &n, &kd, input, &ldab, evalues, evectors, &n, work,
...
int dsbev( int n, int kd, double* input, double* evalues, double* evectors )
{
    ...
    dsbev_( "V", "U", &n, &kd, input, &ldab, evalues, evectors, &n, work,
            &info );
